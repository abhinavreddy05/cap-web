            ...
            class d extends a.default {
                ...
                async _setupLotties() {
                    this.element.querySelectorAll(".card-lottie").forEach((async t => {
                        const e = t.querySelector(".logo");
                        this._cardLogos.push(e), t.querySelectorAll(".logo-lottie").forEach((async e => {
                            const i = await new u.default({
                                el: e,
                                autoplay: !1,
                                renderer: "canvas",
                                loop: !1,
                            ...
                            i.activate(), t.addEventListener("mouseenter", (() => {
                                i.animation.setDirection(1), i.animation.play()
